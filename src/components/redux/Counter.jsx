  ...
  render() {
    return (
        <p className="text-2xl mb-2">
          <span className="m-4 p-1 bg-blue select-none" onClick={this.props.increment}>+</span>
          <span className="m-4 p-1 bg-blue select-none" onClick={this.props.decrement}>-</span>
